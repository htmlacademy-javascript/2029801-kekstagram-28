...
const getRandomInteger = (a, b) => { /* Возвращает случайное целое число в заданном диапазоне */
...
const getRandomArrayElement = (elements) => elements[getRandomInteger(0, elements.length - 1)]; /* Возвращает случайный элемент массива */

export {isStringOptimal};
export {isItPalindrome};
export {getNumber};
export {getOptimalStringWithPad};
